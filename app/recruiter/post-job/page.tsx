        ...
        <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <div className="flex items-center">
            ...
            <p className="text-blue-800 text-sm">
              <strong>AI-Powered Matching:</strong> When you post this job, our AI will automatically analyze and match it against all existing candidates in the system.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t">
            ...
            >
                      ...
                      <>
                        ...
                        Posting Job & Matching Candidates...
                      </>
                    ) : (
                      'Post Job'
                    )}
