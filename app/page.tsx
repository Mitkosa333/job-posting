      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600">Find flexible remote opportunities from companies worldwide</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Fast Apply</h3>
            <p className="text-gray-600">Apply to multiple jobs quickly with our streamlined process</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            ...
            <p className="text-gray-600">All companies are verified to ensure legitimate opportunities</p>
          </div>
        </div>
      </div>
    </div>
